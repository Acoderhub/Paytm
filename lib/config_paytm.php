...
define('PAYTM_MERCHANT_KEY', 'g4ojOJfr&KPGCJR!'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'vWtIhM34899179768150'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
define('PAYTM_REFUND_URL', 'http://paytment.earn4url.com');
